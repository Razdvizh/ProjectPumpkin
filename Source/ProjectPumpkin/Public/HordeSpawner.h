...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Mass|Spawn", meta = (DisplayName = "Activator", ToolTip = "Class that will trigger the spawn when it overlaps with ActivationVolume."))
